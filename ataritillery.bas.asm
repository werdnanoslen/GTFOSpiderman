...
.L053 ;  if sc1 = $00  &&  sc2 = $00  &&  sc3 > 24 then count = 10  :  goto win
...
.L080 ;  if joy0up then p0power = p0power + 0.1
...
.condpart17
	...
	STA p0power
.skipL080
.L081 ;  if joy0down then p0power = p0power - 0.1
...
.L088 ;  if joy0fire  &&  ballflies = 0 then ballflies = 1  :  random = rand
...
.skip22then
.skipL088
.L089 ;  if collision(ball,playfield) then ballflies = 0  :  goto main
...
.skipL089
.L090 ;  if collision(ball,player1)  &&  lethal = 1  &&  ballflies = 1 then ballflies = 0  :  goto hit
...
.skip25then
.skipL090
.L091 ;  if collision(ball,player1)  &&  lethal = 0  &&  ballflies = 1 then ballflies = 0  :  goto catch
